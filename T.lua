        ...
        loadstring([[
            ...
            local function hasInteractable(obj)
                ...
                for _, child in pairs(obj:GetDescendants()) do
                    if child:IsA("ClickDetector") or child:IsA("ProximityPrompt") or child:IsA("TouchInterest") or child:IsA("Tool") then                        return true
                    end
                end
                return false
            end
            ...
            print("自动互动已加载（靠近材料30格内自动互动，已跳过Map）")
        ]])()
    end)
end
